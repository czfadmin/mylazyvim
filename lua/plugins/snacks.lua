        ...
        indent = {
            ...
            indent = {
                ...
                hl = {"SnacksIndent1", "SnacksIndent2", "SnacksIndent3", "SnacksIndent4", "SnacksIndent5",
                      "SnacksIndent6", "SnacksIndent7", "SnacksIndent8"} ---@type string|string[] hl groups for indent guides
            },
            animate = {
            ...
            scope = {
                ...
                hl = {"SnacksIndent1", "SnacksIndent2", "SnacksIndent3", "SnacksIndent4", "SnacksIndent5",
                      "SnacksIndent6", "SnacksIndent7", "SnacksIndent8"} ---@type  string|string[] hl group for scopes
            },
            chunk = {
